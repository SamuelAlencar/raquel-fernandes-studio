...
export default function Footer() {
  return (
    <>
      <footer className="text-center bg-rose-900 text-white">
        <div className="container-full px-6 pt-6">
          ...
          <div>
            <form action="">
              <div className=" md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
                ...
                border border-solid border-rose-300
                rounded
                transition
                ease-in-out
                m-0
                focus:text-rose-700 focus:bg-white focus:border-blue-600 focus:outline-none
              "
